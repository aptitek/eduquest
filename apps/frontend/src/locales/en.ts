...
export const en: TranslationKeys = {
  ...
  map: {
    ...
    errors: {
      ...
      updateAnswerFields: 'Boss answer fields could not be saved. The previous fields were restored. Detail: {detail}',
  ...
  directory: {
    ...
    card: 'card',
    cards: 'cards',
    rewardGuildTitle: 'Reward {guild}',
    rewardBasePoints: 'Base points',
    rewardType: 'Reward type',
    rewardHoursEarly: 'Hours early',
    rewardActiveDays: 'Active days',
    rewardSubmit: 'Give reward',
    rewardSubmitting: 'Granting...',
    rewardTypes: {
      strength: 'Strength',
    ...
    errors: {
      ...
      rewardGuild: 'The reward could not be granted to the guild. Detail: {detail}',
    },
  },
  bonus: {
    nav: 'Reward',
  ...
  activityCard: {
    ...
    resubmitBossAnswer: 'Resubmit boss answer',
    lastSubmittedAt: 'Last submission: {date}',
    submissionDeadline: 'Submission deadline',
    submissionDeadlineAt: 'Deadline: {date}',
    submissionClosedAt: 'Deadline passed on {date}',
    submissionClosed: 'Submission closed',
    filesSelected: '{count}/{max} file(s) selected.',
    fileLimit: 'Up to {max} file(s), {size} each.',
    bossAnswerFields: 'Boss answer fields',
    addAnswerField: 'Add field',
    removeAnswerField: 'Remove field',
    noAnswerFields: 'No answer fields configured.',
    answerFieldId: 'Identifier',
    answerFieldLabel: 'Label',
    answerFieldKind: 'Type',
    answerKindText: 'Text',
    answerKindUrl: 'URL',
    answerKindFile: 'File',
    answerFieldRequired: 'Required',
    answerFieldPlaceholder: 'Placeholder',
    answerFieldHelp: 'Displayed help',
    answerFieldAccept: 'Accepted types',
    answerFieldMaxFiles: 'Max files',
    answerFieldMaxMb: 'Max MB',
