export const fr = {
  ...
  management: {
    ...
    impersonation: {
      ...
      returnToAdmin: 'Revenir au compte admin',
    },
    table: {
      actions: 'Actions',
  ...
  map: {
    ...
    errors: {
      ...
      updateAnswerFields: 'Les champs de réponse du boss n’ont pas pu être enregistrés. Les champs précédents ont été restaurés. Détail : {detail}',
  ...
  directory: {
    ...
    card: 'carte',
    cards: 'cartes',
    rewardGuildTitle: 'Récompenser {guild}',
    rewardBasePoints: 'Points de base',
    rewardType: 'Type de récompense',
    rewardHoursEarly: "Heures d'avance",
    rewardActiveDays: 'Jours actifs',
    rewardSubmit: 'Donner la récompense',
    rewardSubmitting: 'Attribution...',
    rewardTypes: {
      strength: 'Force',
    ...
    errors: {
      ...
      rewardGuild: 'La récompense n’a pas pu être attribuée à la guilde. Détail : {detail}',
    },
  },
  bonus: {
    nav: 'Récompense',
  ...
  activityCard: {
    ...
    resubmitBossAnswer: 'Resoumettre la réponse au boss',
    lastSubmittedAt: 'Dernière soumission : {date}',
    submissionDeadline: 'Deadline de soumission',
    submissionDeadlineAt: 'Deadline : {date}',
    submissionClosedAt: 'Deadline dépassée depuis le {date}',
    submissionClosed: 'Soumission fermée',
    filesSelected: '{count}/{max} fichier(s) sélectionné(s).',
    fileLimit: 'Jusqu’à {max} fichier(s), {size} chacun.',
    bossAnswerFields: 'Champs de réponse du boss',
    addAnswerField: 'Ajouter un champ',
    removeAnswerField: 'Retirer le champ',
    noAnswerFields: 'Aucun champ de réponse configuré.',
    answerFieldId: 'Identifiant',
    answerFieldLabel: 'Libellé',
    answerFieldKind: 'Type',
    answerKindText: 'Texte',
    answerKindUrl: 'URL',
    answerKindFile: 'Fichier',
    answerFieldRequired: 'Obligatoire',
    answerFieldPlaceholder: 'Placeholder',
    answerFieldHelp: 'Aide affichée',
    answerFieldAccept: 'Types acceptés',
    answerFieldMaxFiles: 'Fichiers max',
    answerFieldMaxMb: 'Mo max',
