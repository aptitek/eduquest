...
export const DEBUG_ACTIVITIES: Activity[] = [
  {
    ...
    cardColor: 'var(--color-solarized-yellow)',
  ...
  },
  {
    ...
    sectorDepth: 1,
    requiredLevel: 1,
    stepRanges: [{ startStep: 0, endStep: 5 }],
  ...
  },
  {
    ...
    cardColor: 'var(--color-solarized-cyan)',
    participationMode: 'guild',
    metadata: {},
  ...
  },
  {
    ...
    sectorDepth: 2,
    requiredLevel: 2,
    stepRanges: [{ startStep: 3, endStep: 6 }],
    cardColor: 'var(--color-solarized-violet)',
    participationMode: 'guild',
    metadata: {},
